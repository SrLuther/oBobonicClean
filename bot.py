...
async def criar_painel_ticket():
    ...
    painel_msg = await canal.send(
        ...
        "**⏱️ Tempo de Resposta:**\n"
        "⚡ O tempo de resposta varia de acordo com a disponibilidade da equipe\n"
        "⚡ Mas garantimos que será respondido o quanto antes possível\n"
        "⚡ Tickets urgentes receberão prioridade\n\n"
        "**📚 Categorias Comuns:**\n"
